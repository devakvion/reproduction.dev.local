<div class="human-svg">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 630 500">
        <defs>
            ...
            <filter id="f" width="316.7%" height="316.7%" x="-108.4%" y="-108.4%" filterUnits="objectBoundingBox">
                <feGaussianBlur in="SourceGraphic" stdDeviation="6.502"/>
            </filter>
            <filter id="g" width="343.8%" height="343.8%" x="-121.9%" y="-121.9%" filterUnits="objectBoundingBox">
                <feGaussianBlur in="SourceGraphic" stdDeviation="6.502"/>
            </filter>
            <filter id="h" width="343.8%" height="343.8%" x="-121.9%" y="-121.9%" filterUnits="objectBoundingBox">
                <feGaussianBlur in="SourceGraphic" stdDeviation="6.502"/>
            </filter>
        </defs>
        <g fill="none" fill-rule="evenodd" transform="translate(-197 -47)">
            <g transform="translate(197 47)">
                ...
                <image xlink:href="/img/index-img/people-3.min.png" x="145" width="340.26" height="500" />
                <g class="w-end-m" transform="translate(25 42)">
                    <g class="w-org  Матка" transform="translate(0 296)">
                        ...
                        <g class="org-gr" transform="translate(0 20)">
                            <g class="gr-m">
                                <circle cx="45" cy="45" r="45" fill="#FFF" stroke="#495466" stroke-width="1.2"/>
                    ...
                    <g class="w-org  Гипофиз">
                        <g transform="translate(44)">
                            <path stroke="#606D88" d="M160.687181 10.7189121L76 56.066406 0.812500018 56.066406"/>
                            <circle cx="162.357" cy="9.514" r="9" fill="#125198" class="blur" filter="url(#d)"/>
                ...
                <g class="m-end-w" transform="translate(350 46)">
                    <g class="m-org  Половой  член" transform="translate(1 312)">
                        ...
                        <g class="org-gr" transform="translate(164)">
                            <g class="gr-m">
                                <circle cx="45.667" cy="45" r="45" fill="#FFF" stroke="#495466" stroke-width="1.2"/>
                    ...
                    <g class="m-org  Яички" transform="translate(14 212)">
                        <g transform="translate(0 38)">
                            ...
                            <circle cx="9.285" cy="70.341" r="9" fill="#065BB9" class="blur" filter="url(#f)" opacity=".695"/>
                    ...
                    <g class="m-org  ДНК  сперматозоидов" transform="translate(0 110)">
                        <g transform="translate(0 44)">
                            ...
                            <circle cx="8.285" cy="150.341" r="8" fill="#065BB9" class="blur" filter="url(#g)" opacity=".695"/>
                            <circle cx="8.285" cy="153.341" r="5" fill="#4B6186"/>
                        </g>
                        <g class="org-gr" transform="translate(166)">
                            <g class="gr-m">
                                <circle cx="45.333" cy="45" r="45" fill="#FFF" stroke="#495466" stroke-width="1.2"/>
                    ...
                    <g class="m-org  Гипофиз" transform="translate(42)">
                        <g>
                            <path stroke="#606D88" d="M8.52054038 10.6323686L92.9999998 52.2734377 168.828125 52.2734377"/>
                            <circle cx="8.285" cy="8.341" r="8" fill="#065BB9" class="blur" filter="url(#h)" opacity=".695"/>
                        ...
                        <g class="org-gr" transform="translate(125 5)">
                            <g class="gr-m">
                                ...
                                <circle cx="50.571" cy="50.657" r="6.429" stroke="#5F98D7" stroke-width="1.5" class="m-item"/>
                            </g>
                        </g>
                    </g>
                </g>
