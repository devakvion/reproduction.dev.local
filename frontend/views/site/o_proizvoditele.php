...
<header id="header-top">
    <div class="row header-row-top hed-all-bg bg-header_pr">
        <div class="bg-header_pr_before"></div>
        <div class="con-hd">
                ...
                <nav class="breadcrumbs" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                    <ol class="cd-multi-steps">
                        ...
                        <li class="current" itemprop="itemListElement" itemscope
                            itemtype="https://schema.org/ListItem">
                            <span itemprop="name">О производителе</span>
...
<!-- Main Section
================================================== -->
<div class="row block-animate proizviditel">
    <div class="con-hd bl-pr-it container-bg-gray">
        <div class="row fl-pr">
            <div class="p-pr-r">
                <div class="vertical-line">
                    <noindex><h3 class="title-section after-line h-pr-t">
                            О производителе
                        </h3></noindex>
                    <p>Производитель и разработчик продуктов бренда – российская фармацевтическая компания АКВИОН.</p>
                    <p>Компания АКВИОН объединяет в своих продуктах новейшие научные открытия, результаты последних
                        исследований, современные стандарты фармпроизводства и инновационные технологии. </p></div>
            </div>
            <div class=" p-pr-l ">
                <img class="img-pr" src="/img/proizviditel/1.jpg"
                     alt="О производителе Аквион">
            </div>
        </div>
        <div class="row pr-last fl-pr">
            <div class="p-pr-l">
                <p><strong>Продукция компании АКВИОН – это гарантия эффективности и безопасности:</strong></p>
                <ul class="list-article pr-list">
                    <li> Составы разрабатываются в собственной технологической лаборатории «Центр разработок и инноваций». </li>
                    <li> В качестве активных компонентов используются только те вещества, эффективность которых клинически доказана.</li>
                    <li> Для производства закупается европейское сырье высокого качества.</li>
                    <li> Место производства – современное российское фармацевтическое предприятие ВТФ, которое полностью соответствует требованиям международных стандартов ISO 22000 и GMP</li>
                </ul>
                <p>Компании АКВИОН принадлежит создание нескольких десятков оригинальных препаратов, получивших широкое признание среди потребителей и специалистов. </p>
            </div>
            <div class="p-pr-r">
                <img class="img-pr" src="/img/proizviditel/2.jpg"
                     alt="О производителе Аквион">
            </div>
        </div>
        <!--Empty Block-->
...
$this->registerCssFile('/css/proizviditel.css');
?>