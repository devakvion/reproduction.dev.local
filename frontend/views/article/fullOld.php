                    ...
                    <div class="nws-item">
                        ...
                        <div class="article-wr">
                            <img class="article-img"
                                 src="<?= $model->imageDir . $model->id . '/' . $model->img_big ?>"
                                 alt="<?= $model->title ?>" align="left">

                            <div class="article-data">
                                <h3 class="title-article after-line"><?= $model->title ?></h3>
