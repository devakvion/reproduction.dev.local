            ...
            <div class="left-header txt-right pl-first-baby">
                <div class="wr-txt-header">
                    ...
                    <h1 class="BebasNeueBold header-color title-problem-header">
                        Как планировать <br> первую беременность, если вам больше 35 лет
                        <!--  SVG   -->
        ...
        <div class="container-pr">
            ...
            <div id="wr-col-article" class="col-2 pad-col2">
                        ...
                        <div class="left-article p-pr-r">
                            ...
                            <span class="item-number-article">
                                ...
                                <span class="vertical-line"></span>
                                    ...
                                    <!--  Article   -->
                                    <p>
                                        <b>Сегодня многие решаются стать родителями в возрасте</b>, когда за спиной
                                        есть
                                        надежный
                                        тыл – жилье, сбережения, карьера. Но часто можно услышать, что после 35
                                        рожать
                                        детей
                                        уже поздно. Однако в действительности природа не накладывает ни на мужчину,
                                        ни
                                        на
                                        женщину таких строгих ограничений, как сложившиеся стереотипы. Во многих
                                        странах
                                        уже
                                        давно не используется термин «старородящая», и к будущим мамам старше 35 лет
                                        относятся совершенно нормально.
                                        Важно лишь учитывать, что подготовка к первой беременности должна быть более
                                        тщательной, чтобы все те факторы, которые влияли на организм родителей на
                                        протяжении
                                        всей их жизни, не сказались на здоровье их будущего ребенка.
                        ...
                        <div class="column-svg">
                            <div class="wr-svg-article active">
                                ...
                                <svg id="human-woman" viewBox="0 0 640 500"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <title>Как планировать первую беременность, если вам больше 35 лет</title>
                            ...
                            <article>
                                <h3 class="title-article after-line">Что меняется в организме мужчины – и
                                    почему?</h3>

                                <p>
                                    <b>Мужчины оказались счастливчиками</b> – в отличие от женщин, они могут стать
                                    отцами в
                                    течение всей жизни. Но и мужчин не обходят стороной возрастные изменения.
                                    Нередко к
                                    этому возрасту у мужчин появляются хронические заболевания сердечно-сосудистой
                                    системы, проблемы с весом, эндокринные нарушения (диабет) и вредные привычки.
                                    <br>
                                    Эти
                                    болезни так или иначе сказываются на работе репродутивной системы мужчины. Кроме
                                    того, начиная с 35 лет, у мужчин снижается уровень половых гормонов, что
                                    несколько
                                    уменьшает мужскую фертильность (возможность стать отцом). <br> Возникает
                                    вероятность
                                    эректильной дисфункции, ухудшается качество спермы. Уменьшается количество
                                    подвижных
                                    сперматозоидов с правильным строением. А это значит, что повышается шанс
                                    оплодотворения яйцеклетки сперматозоидом с неправильным строением, что может
                                    привести к выкидышам, врождённым заболеваниям или другим дефектам у детей. Кроме
                                    того, ДНК-нить в сперматозоидах немолодого мужчины может быть «разорванной» -
                                    это
                                    приводит к аномалиям в развитии ребёнка. <br>
                                    Разумеется, причина изменения состава спермы – это совсем не общее слово
                                    «возраст»,
                                    а набор заболеваний и общего ухудшения состояния организма, который мужчина
                                    накапливает к своим 35 годам. <br>
                                    Это и проблемы с сосудами (диабет, артериальная гипертензия), и хронические
                                    инфекции
                                    (<a href="/muzhskoe_zdorovie/prostatit">простатит</a> и др.), а также ожирение и
                                    гормональная недостаточность. Даже если вы
                                    ведёте здоровый образ жизни, не забывайте, что и окружающая среда не бывает
                                    милосердна к людям: в городском воздухе меньше кислорода, зато больше вредных
                                    веществ. На организм постоянно воздействует электромагнитное излучение из
                                    различных
                                    источников, пестициды, бытовая химия, выхлопные газы тысяч машин… Всё это
                                    постепенно
                                    вызывает рост активных частиц в организме – свободных радикалов. Когда их много,
                                    они
                                    нарушают обмен веществ в организме, меняют структуру ДНК сперматозоидов.
                                    Способность
                                    сперматозоида проникать в яйцеклетку ухудшается, снижается подвижность
                                    сперматозоидов. Такая ситуация называется окислительным стрессом. Его
                                    воздействие,
                                    безусловно, уменьшает вероятность зачатия
                                </p>
                            </article>
                        </div>
                    </div>
                ...
                <div class="row block-animate">
                    <div class="special-article">
                        <div class="wr-special-article">
                            <h5 class="after-line">Помните</h5> <br>
                            Три месяца бережного отношения к себе приблизят день рождения вашего ребёнка! <br>
                            Берегите своё здоровье – и вы сбережёте здоровье своего будущего малыша.
                            <div class="wr-i-info">
                ...
                <div class="row  block-animate bl-pr-it bg-beige-light">
                    <div class="con-pr-em">
                        <div class="columh-block">
                            <article>
                                <h3 class="title-article after-line">Что делать мужчине?</h3>

                                <p>
                                    <b>Мужчине старше 35 лет</b>, решившему стать отцом, следует принять все меры,
                                    чтобы
                                    улучшить свой генетический материал. Сперматозоиды растут и созревают за 72 дня,
                                    поэтому достаточно трех месяцев внимательного отношения к себе, чтобы повысить
                                    вероятность зачатия и уменьшить риск генетических отклонений у вашего будущего
                                    ребенка. <br>
                                    На процесс выработки и на качество спермы положительно влияют определённые
                                    вещества:
                                    L-карнитин, цинк и селен, фолиевая кислота, витамин Е. Доказано, что прием этих
                                    веществ на протяжении трёх месяцев улучшает формирование спермы, повышает
                                    концентрацию и подвижность сперматозоидов, а также количество сперматозоидов с
                                    правильным строением (что позволит сперматозоиду успешно оплодотворить
                                    яйцеклетку).
                                    И если в более молодом возрасте мужчина может прибегнуть к помощи этих
                                    витаминов,
                                    минералов и аминокислот только после неудачных попыток зачатия, то мужчинам,
                                    которые
                                    собираются стать отцами после 35 лет, желательно принимать препараты для
                                    улучшения
                                    качества спермы в период подготовки к зачатию. Просто чтобы не терять время и
                                    улучшить то, что уже совершенно точно нуждается в поддержке. Кстати, поддержать
                                    репродуктивную систему достаточно просто – комбинированный препарат <a
                                        href="/nashi_produkty/speroton">«Сперотон»</a>
                                    содержит все необходимые вещества в высоких дозировках, которые благоприятно
                                    влияют
                                    на качество спермы. <br>
                                    Для защиты генетического материала от вредного воздействия окислительного
                                    стресса,
                                    требуются антиоксиданты. Они защищают структуру ДНК от изменения, предохраняют
                                    хвостик и головку сперматозоида от повреждений. Прием ликопина снижает
                                    окислительный
                                    стресс в сперме. Кроме того, употребление ликопина предупреждает появление
                                    доброкачественной гиперплазии простаты или замедляет ее развитие. При приеме
                                    витамина Е, витамина С, коэнзима Q<sub>10</sub> уменьшается количество
                                    сперматозоидов с
                                    поврежденными генами, увеличивается плотность спермы и подвижность
                                    сперматозоидов.
                                    Для того, чтобы избежать проблем с ДНК сперматозоидов, вы можете принимать
                                    препарат
                                    <a href="/nashi_produkty/sinergin">«Синергин»</a>, в состав которого входит 6
                                    природных антиоксидантов.
                                    Можно придерживаться и еще некоторых правил подготовки к зачатию, которые
                                    приведены
                                    в <a href="/muzhskoe_zdorovie/podgotovka_k_zachatiju">памятке</a>.
                ...
                <div class="row  block-animate bl-pr-it bg-beige-light">
                    <div class="con-pr-em">
                        <div class="columh-block">
                            <h3 class="title-article after-line">Женщина старше 35 лет</h3>

                            <p>
                                Женщинам при планировании первой беременности после 35 лет сложнее, чем
                                мужчинам.
                                Дело в том, что способность женщины зачать ребёнка с возрастом начинает угасать.
                                Между 35 и 40 годами женщина может с некоторыми сложностями забеременеть,
                                выносить и
                                родить ребёнка, но с 45 годам возможность родить малыша начинает быстро
                                уменьшаться.
                                Однако способность зачатия не зависит напрямую именно от возраста. Зачать в
                                зрелом
                                возрасте вполне возможно, если у женщины хорошее здоровье, а её партнёр
                                находится в
                                хорошей форме и способен дать жизнь будущему ребёнку.
                            </p>

                            <p>
                                <b> Женщину старше 35 лет, решившую стать мамой, могут ожидать следующие
                                    проблемы:
                                </b>
                            </p>
                            <ul class="list-article">
                                <li>Ненаступление беременности дольше <span style="display: inline-block">6 месяцев</span>.
                                </li>
                                <li>Рождение ребенка с генетическими отклонениями (чем старше женщина, тем выше
                                    риск
                                    синдрома Дауна).
                                </li>
                                <li>Осложнения во время беременности.
                                </li>
                            </ul>
                            <p>
                                Это связано с тем, что в отличие от мужских, женские половые клетки не
                                обновляются,
                                а закладываются в яичниках на всю жизнь. В течение жизни на яичники воздействуют
                                негативные факторы внешней среды, приём лекарств, заболевания. В результате
                                повреждаются как сами яйцеклетки, так и генетический материал (ДНК), который в
                                них
                                заложен. С возрастом количество повреждённых яйцеклеток увеличивается.
                                Повреждённая
                                яйцеклетка может быть неспособной к оплодотворению или нести ущербный
                                генетический
                                материал. В результате – невозможность зачать ребёнка, невынашивание
                                беременности,
                                рождение ребёнка с генетическими отклонениями.
                                Кроме того, к 35 годам многие женщины уже страдают хроническими заболеваниями,
                                которые могут осложнить течение беременности (сердечно-сосудистые заболевания,
                                инфекционные заболевания и т.д.).
                            </p>
                            <p>
                                При планировании беременности женщине старше 35 лет желательно действовать по
                                плану. <br>
                                Схема и последовательность действий изложены в нашей памятке для тех, <a
                                    href="/zhenskoe_zdorovie/podgotovka_k_beremennosti">кто планирует
                                    стать мамой</a>. <br>
                                Но есть и особые рекомендации для женщин старше 35 лет. Обязательно посетите
                                генетика. По итогам полного обследования врач-генетик сформирует заключение о
                                риске
                                рождения больного ребенка в дальнейшем, даст необходимые индивидуальные
                                рекомендации. <br><br>
                                Отдельно стоит сказать о необходимости приема антиоксидантных комплексов. Как
                                показали исследования, прием антиоксидантов при подготовке к зачатию и во время
                                беременности снижает риск развития таких осложнений беременности, как
                                преэклампсия
                                (заболевание, при котором появляются отёки, давление на плод, плохо влияющие и
                                на
                                организм ребёнка, и на организм матери) и преждевременные роды, предупреждает
                                развитие синдрома задержки роста плода и способствует рождению здорового
                                ребёнка.
                                Для поддержания нормального артериального давления у беременных крайне важны
                                витамин
                                Е, ликопин и бета-каротин. <br> При недостаточном содержании витамина Е,
                                бета-каротина и
                                ликопина увеличивается риск проблем с беременностью и повреждения плода. <br>
                                Кроме
                                того,
                                низкое содержание этих веществ в организме женщины увеличивает риск выкидыша.
                                Поэтому, помимо стандартных витаминно-минеральных комплексов для женщин,
                                планирующих
                                зачатие, рекомендуется обратить внимание на антиоксидантные препараты с
                                ликопином,
                                бета-каротином, витамином Е (например, <a
