                            ...
                            <!--  SVG   -->
                                <span class="wr-svg-header">
                                    <svg id="couples-svg" class="svg-slider-category" viewBox="0 0 122 122"
                                        ...
                                        <desc>Повторное невынашивание беременности</desc>
                                    </svg>
                                </span>
                        </h1>
                        ...
                        <div class="con-pr-em">
                                ...
                                <div class="txt-left min_height" data-mh="group-im-pr">
                                    <div class="align-vertical">
                                        <h2 class="title-section after-line h-pr-t">
                                            Повторное <br> невынашивание беременности
                            <span class="item-number-article">
                                ...
                                <span class="vertical-line"></span>
                                        ...
                                        <!--  Article   -->
                                        <p>
                                            <b>Статистика гласит:</b> 15–20 % беременностей заканчиваются неудачно —
                                            плод не
                                            развивается или происходит невынашивание (выкидыш). Риск повторного
                                            невынашивания
                                            беременности растет: после двух выкидышей он составляет 24 %, после трех —
                                            30 %,
                                            после четырех — 40 %. Диагноз «привычное невынашивание беременности»
                                            ставится
                                            уже
                                            после второй или третьей неудачи. И за каждой неумолимой цифрой —
                                            человеческая
                                            трагедия. Наука постоянно пытается понять причины этого явления и найти
                                            средства
                                            победить их.
                        ...
                        <div class="con-pr-em">
                            <div class="column-svg">
                                <div class="wr-svg-article">
                                    <img class="full-img" src="/img/menWoman-img-problem/empty.png" alt="empty">
                                    <svg id="human-woman" viewBox="0 0 640 500" xmlns="http://www.w3.org/2000/svg">
                                        <title>Привычное невынашивание беременности</title>
                                        <desc> Повторные выкидыши</desc>
                                        <g id="point-main"></g>
                                        <!--  Men End Women   -->
                                ...
                                <article>
                                    <h3 class="title-article after-line">Причины</h3>

                                    <p>
                                        <b>Главными причинами хронического невынашивания считаются:
                                        </b>
                                    </p>
                                    <ul class="list-article">
                                        <li>Инфекции мочеполовой системы.

                                        </li>
                                        <li>Предрасположенность к образованию тромбов (тромбофилия), проблемы с
                                            ферментами
                                            (нарушения фолатного цикла).
                                        </li>
                                        <li>Антифосфолипидный синдром (АФС) — аутоиммунное заболевание, когда организм
                                            вырабатывает слишком много антител к фосфолипидам (химическим структурам, из
                                            которых построены части клетки).
                                        </li>
                                        <li>
                                            Биологическая несовместимость родителей — за нее отвечают специальные гены
                                            HLA
                    ...
                    <div class="row  block-animate bl-pr-it bg-beige-light">
                        <div class="con-pr-em">
                            <div class="columh-block">
                                <article>
                                    <h3 class="title-article after-line">Инфекции мочеполовой системы</h3>

                                    <p>
                                        Главное при лечении — удалить возбудителей инфекций, в том числе, передающихся
                                        половым путем (хламидии, микоплазмы, уреаплазмы, гарднереллы и т. п.). Поэтому
                                        иногда лечение требуется обоим партнерам.
                                    </p>

                                    <h3 class="title-article after-line">Повышенная свертываемость крови</h3>

                                    <p>
                                        Если у беременной повышенная свертываемость крови, возникает риск ДВС-синдрома
                                        (диссеминированное внутрисосудистое свертывание крови): кровь в сосудах
                                        загустевает,
                                        и нарушается плацентарный кровоток. В результате плод не получает полноценного
                                        питания и развивается слишком медленно. Возможно даже замирание беременности.
                                        Поэтому очень важно вовремя сдать анализ на гемостаз, чтобы избежать осложнений.
                                    </p>

                                    <h3 class="title-article after-line">Антифосфолипидный синдром (АФС)</h3>

                                    <p>
                                        Так называют группу аутоиммунных нарушений, когда организм вырабатывает антитела
                                        к
                                        некоторым собственным фосфолипидам. Это тоже опасно для роста и развития плода,
                                        течения беременности и родов.
                                    </p>

                                    <h3 class="title-article after-line">Совпадения в системе HLA</h3>

                                    <p>
                                        Иммунная система матери должна правильно реагировать на появление эмбриона и
                                        не
                                        отторгать его. При определенных сочетаниях генов HLA у матери и отца
                                        будущего
                                        ребенка беременность может прерваться. После слияния мужской и женской
                                        клеток
                                        образуется зародыш, получающий от отца и матери специальные белки —
                                        антигены.
                                        Для
                                        нормального закрепления и развития плода очень важна их «чужеродность», т.
                                        е.
                                        HLA-гены родителей должны различаться. <br> Именно их различия запускают в
                                        организме
                                        матери особые иммунные реакции, направленные на сохранение беременности —
                                        блокируются клетки, способные спровоцировать выкидыш. Полное совпадение
                                        HLA-генов
                                        бывает у близких родственников (отсюда происходит понятие «вырождение» в
                                        близкородственных браках). Но в природе бывают и случайности. <br> Даже если
                                        родители —
                                        не родственники, может оказаться, что их HLA-гены частично совпадают, что
                                        может
                                        вызвать серьезные проблемы для сохранения беременности.
                                    </p>

                                    <h3 class="title-article after-line">Хромосомные аномалии</h3>

                                    <p>
                                        Остановимся на этой причине подробнее. Хромосомные аномалии обнаруживаются
                                        больше
                                        чем у половины эмбрионов после выкидыша в первые 13 недель. Беременность с
                                        генетическими проблемами с вероятностью 95 % заканчивается неблагоприятно. Ведь
                                        выкидыш — один из защитных механизмов, данных природой, чтобы заведомо
                                        нежизнеспособное потомство не появлялось на свет.
                                        Часть хромосомных отклонений возникает случайно и при следующих беременностях не
                                        повторяется. Но есть и хромосомные аномалии, связанные с генами родителей. Из-за
                                        них
                                        неудачные беременности, к сожалению, могут не раз преследовать одну и ту же
                                        пару.
                                    </p>
                                </article>
                            </div>
                        ...
                        <div class="con-pr-em">
                            <div class="columh-block">
                                <article>
                                    ...
                                    <p>
                                        С развитием науки все причины привычных выкидышей постепенно переходили из
                                        разряда
                                        безнадежных препятствий для продолжения рода в решаемые проблемы. Однако до
                                        недавнего времени считалось, что повлиять на появление генетических отклонений
                                        невозможно, но современная медицина смотрит и на это по-другому. Если
                                        установлено,
                                        что  Повторные выкидыши возникают в результате генетических проблем, то
                                        необходима
                                        консультации специалиста-репродуктолога. Он назначит дополнительные исследования
                                        и
                                        на их основании будут определяться возможные пути решения проблемы. Сегодня
                                        можно
                                        значительно уменьшить риск генных отклонений, если заранее знать о его
                                        возможности.
                                    </p>

                                    <div class="not-col">
                                        <h3 class="title-article after-line">Возраст и вероятность хромосомных
                                            аномалий</h3>

                                        <p>
                                            С возрастом у женщин снижается запас яйцеклеток, а также нарушается
                                            хранящийся в
                                            них
                                            генетический материал. Поэтому чем старше женщина, тем выше риск рождения
                                            ребенка с
                                            синдромом Дауна (нарушение количества хромосом) и другими генетическими
                                            заболеваниями. Защитить яйцеклетки от повреждений хорошо помогают
                                            антиоксиданты,
                                            поэтому их стоит принимать всем женщинам старше 35. В частности, для защиты
                                            репродуктивной системы подойдет <a
                                                href="/nashi_produkty/sinergin">Синергин</a>,
                                            который содержит 6 мощных природных
                                            антиоксидантов. <br>
                                            У мужчин способность к продолжению рода (фертильность) сохраняется
                                            практически
                                            всю
                                            жизнь, но эта функция тоже постепенно ухудшается.
                                            С возрастом сокращается объем спермы, становится меньше сперматозоидов,
                                            снижается их
                                            подвижность. Генетический материал, хранящийся в сперматозоидах, также
                                            подвергается
                                            повреждениям – появляются разрывы в цепочке ДНК (дефрагментация ДНК
                                            сперматозоидов),
                                            что снижает возможность беременности. У бесплодных мужчин процент
                                            сперматозоидов
                                            с
                                            нарушением целостности ДНК составляет более 30 %, у здоровых фертильных
                                            мужчин —
                                            менее 15 %.
                                    ...
                                    <p>
                                        <b>Основные показания к проведению оценки фрагментации ДНК сперматозоидов:
                                        </b>
                                    </p>
                                    <ul class="list-article">
                                        <li>Бесплодие неясного происхождения, когда спермограмма в норме.
                                        </li>
                                        <li> Повторные выкидыши на ранних сроках и невынашивание беременности.
                                        </li>
                                        <li>Многочисленные неудачные попытки искусственного оплодотворения.
                                        </li>
                                        <li>
                                    ...
                                    <h3 class="title-article after-line">Помощь и лечение при хромосомных аномалиях</h3>

                                    <p>
                                        Пока медицина не продвинулась настолько, чтобы повлиять на возраст. Однако
                                        повлиять
                                        на вероятность развития хромосомных аномалий плода, возможно. Женщине стоит
                                        вести
                                        здоровый образ жизни и принимать антиоксиданты, например, <a
                                            href="/nashi_produkty/sinergin">Синергин</a> – комплекс из 6
                                        мощных антиоксидантов, чтобы защитить репродуктивную систему от повреждения
                                        свободными радикалами. Мужчинам прием антиоксидантов будет еще полезнее, так как
                                        генетический материал мужчин обновляется. 72 дня длится период созревания
                                        сперматозоидов, и если на это время отказаться от курения, сауны, использования
                                        токсических веществ, вести правильный образ жизни и принимать антиоксиданты, то
                                        качество спермы значительно улучшится. Витамины Е, С, ликопин, бета-каротин и
                                        коэнзим Q<sub>10</sub> способствует устранению окислительного стресса в тканях
                                        яичек и
                                        уменьшают риск повышенной фрагментации ДНК сперматозоидов. В результате
                                        повышаются
                                        шансы на зачатие и нормальное течение беременности, уменьшается вероятность
                                        выкидышей, в том числе, у пар, прибегающих к использованию ВРТ. Кроме того,
                                        новорожденные дети меньше болеют.
                                    </p>
                                </article>
                            </div>
                        </div>
