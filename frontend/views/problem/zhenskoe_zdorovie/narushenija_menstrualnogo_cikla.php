            ...
            <div class="left-header txt-right">
                <div class="wr-txt-header">
                    ...
                    <h1 class="BebasNeueBold header-color title-problem-header">
                        Нарушение <br> менструального цикла
                        <!--  SVG   -->
                        ...
                        <div class="column-svg">
                            <div class="wr-svg-article">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 630 500" xmlns:xlink="http://www.w3.org/1999/xlink" >
                                    ...
                                    <g fill="none" fill-rule="evenodd" transform="translate(-906 -2642)">
                                        <g transform="translate(906 2642)">
                ...
                <div class="row bl-pr-it">
                    <div class="con-pr-em">
                        ...
                        <div class="drug-article-left p-pr-r">
                            <h4 class="note-dr-footer">Этот препарат поможет вам справиться с нарушениями менструального цикла</h4>
