        ...
        <div class="con-hd">
            <div class="left-header txt-right">
                <div class="wr-txt-header">
                    ...
                    <div class="p-r-in-bl">
                        <h1 class="BebasNeueBold header-color title-problem-header">Подготовка <br> к беременности – с
                            чего начать?</h1>
                        <!--  SVG   -->
                ...
                <nav class="breadcrumbs" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                    <ol class="cd-multi-steps">
                        ...
                        <li class="current" itemprop="itemListElement" itemscope
                            itemtype="https://schema.org/ListItem">
                            <a href="/<?= $category->path .'/'. $problem->path?>" itemprop="item" title="Наши продукты - <?= $category->title .' - '. $problem->title?>">
                        ...
                        <div class="column-svg">
                            <div class="wr-svg-article">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 630 500" xmlns:xlink="http://www.w3.org/1999/xlink" >
                                    ...
                                    <g fill="none" fill-rule="evenodd" transform="translate(-906 -2122)">
                                        <g transform="translate(906 2122)">
                ...
                <div class="row bl-pr-it">
                    <div class="con-pr-em">
                        ...
                        <div class="drug-article-left p-pr-r">
                            <h4 class="note-dr-footer">Эти препараты помогут вам подготовиться к беременности</h4>
                        ...
                        <div class="drug-article-right p-pr-l">
                            ...
                            <div class="tag-item txt-center">
                                <ul class="l-p-c-a">
                                    ...
                                    <li><a href="/zhenskoe_zdorovie/beremennost"><i
                                                    class="reproduction-tags-2"></i>Беременность</a></li>
                                    <li><a href="/zhenskoe_zdorovie/kormlenie_grudyu"><i
