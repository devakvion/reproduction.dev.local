        ...
        <div class="con-hd">
            <div class="left-header txt-right">
                <div class="wr-txt-header">
                    ...
                    <div class="p-r-in-bl">
                        <h1 class="BebasNeueBold header-color title-problem-header">Что такое цистит?<br> Как вылечить?</h1>
                        <!--  SVG   -->
                ...
                <div class="row block-animate bl-pr-it bg-beige-light">
                    <div class="con-pr-em">
                        ...
                        <div class="right-article p-pr-l">
                            <div class="bg-39 m-img-bg" data-mh="group-im-pr"></div>
                        </div>
                    </div>
                </div>
                <!--Empty Block-->
                        ...
                        <div class="column-svg">
                            <div class="wr-svg-article">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 630 500" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    ...
                                    <g fill="none" fill-rule="evenodd" transform="translate(-911 -4192)">
                                        <g transform="translate(911 4192)">
                ...
                <div class="row bl-pr-it">
                    <div class="con-pr-em">
                        ...
                        <div class="drug-article-left p-pr-r">
                            <h4 class="note-dr-footer">Этот препарат поможет вам предупредить рецидивы цистита</h4>
                            <div class="sum-2-drugs sum-1 txt-center">
                                <!--  Цисталин   -->
                                <figure class="figure-article" data-name-drugs="Цистениум">
                                    <img class="full-img-drugs" src="/img/drugs/drugs-bg/cystenium-bg.png"
                                         alt="Цистениум">
                                    <figcaption>
                                        <a href="/nashi_produkty/cystenium">
                                        <span class="drugs-name-transition">
                           ...
                           <!-- <div class="wr-note-drugs-article">
                            <span class="note-drugs-article">
                                 Этот препарат поможет вам предупредить рецидивы цистита.
                            </span>
                            </div>-->
                        </div>
                        <!--  List Problem   -->
