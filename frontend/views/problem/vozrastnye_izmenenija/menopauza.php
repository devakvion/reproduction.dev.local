        ...
        <div class="con-hd">
            <div class="left-header txt-right">
                <div class="wr-txt-header">
                    ...
                    <div class="p-r-in-bl">
                        <h1 class="BebasNeueBold header-color title-problem-header">Менопауза
                            <br>
                            <span class="span-h1 pt-sans-narrow easy-txt">Как распознать и что делать</span>
                        </h1>
                        <!--  SVG   -->
                            ...
                            <div class="wr-svg-article">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 630 500" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <defs>
                                        ...
                                        <filter id="b" width="343.8%" height="343.8%" x="-121.9%" y="-121.9%" filterUnits="objectBoundingBox">
                                            <feGaussianBlur in="SourceGraphic" stdDeviation="6.502"/>
                                        </filter>
                                        <filter id="c" width="345.6%" height="345.6%" x="-122.8%" y="-122.8%" filterUnits="objectBoundingBox">
                                            <feGaussianBlur in="SourceGraphic" stdDeviation="7.369"/>
                                        </filter>
                                        <filter id="d" width="262.5%" height="262.5%" x="-81.3%" y="-81.3%" filterUnits="objectBoundingBox">
                                            <feGaussianBlur in="SourceGraphic" stdDeviation="6.502"/>
                                        </filter>
                                    ...
                                    <g fill="none" fill-rule="evenodd" transform="translate(-2241 -1096)">
                                        <g transform="translate(2241 1096)">
                                            ...
                                            <g class="w-end-m" transform="translate(25 18)">
                                                <g class="w-org  Мочевой  пузырь" transform="translate(1 188)">
                                                    <g transform="translate(44 45)">
                                                        <path stroke="#606D88" d="M241.773438 152.546875L85.7890625 0.773435699 0.140624988 0.773435699"/>
                                                        <circle cx="244.357" cy="151.514" r="9" fill="#065BB9" class="blur" filter="url(#a)" opacity=".695"/>
                                                        <circle cx="242.357" cy="152.514" r="5" fill="#4B6186"/>
                                                    </g>
                                                    <g class="org-gr">
                                                        <g class="gr-m">
                                                ...
                                                <g class="w-org  Костная  система" transform="translate(326 298)">
                                                    <g transform="translate(0 50)">
                                                        <path stroke="#606D88" d="M10.0976562 89.171875L122.59375 0.944 211.445314 0.944"/>
                                                        <circle cx="8.285" cy="88.341" r="8" fill="#065BB9" class="blur" filter="url(#b)" opacity=".695"/>
                                                        <circle cx="9.285" cy="88.341" r="5" fill="#4B6186"/>
                                                    </g>
                                                    <g class="org-gr" transform="translate(168)">
                                                        <g class="gr-m">
                                                            <circle cx="45" cy="45.5" r="45" fill="#F7F7F7" stroke="#495466" stroke-width="1.2"/>
                                                            <g stroke="#4B5363" stroke-opacity=".566" stroke-width="1.2" transform="translate(16 18)">
                                                ...
                                                <g class="w-org  Молочные  железы" transform="translate(317 74)">
                                                    <g transform="translate(0 46)">
                                                        ...
                                                        <circle cx="12.285" cy="65.841" r="12" fill="#065BB9" class="blur" filter="url(#d)" opacity=".695"/>
                                                ...
                                                <g class="w-org  Кожа" transform="translate(366 187)">
                ...
                <div class="row bl-pr-it">
                    <div class="con-pr-em">
                        ...
                        <div class="drug-article-left p-pr-r">
                            <h4 class="note-dr-footer">Эти препараты помогут в период менопаузы</h4>
