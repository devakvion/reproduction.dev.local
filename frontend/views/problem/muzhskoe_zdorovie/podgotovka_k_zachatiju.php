        ...
        <div class="con-hd">
            <div class="left-header txt-right">
                <div class="wr-txt-header">
                    ...
                    <div class="p-r-in-bl">
                        <h1 class="BebasNeueBold header-color title-problem-header">Подготовка мужчины <br> к зачатию ребенка</h1>
                        <!--  SVG   -->
                        ...
                        <div class="column-svg">
                            <div class="wr-svg-article">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 630 500" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    ...
                                    <g fill="none" fill-rule="evenodd" transform="translate(-1577 -47)">
                                        <g transform="translate(1577 47)">
                ...
                <div class="row bl-pr-it">
                    <div class="con-pr-em">
                        ...
                        <div class="drug-article-left p-pr-r">
                            <h4 class="note-dr-footer">Эти препараты помогут подготовиться к зачатию</h4>
