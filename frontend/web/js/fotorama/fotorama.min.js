...
fotoramaVersion = "4.6.4", function (a, b, c, d, e) {
    ...
    function db(a, b) {
        ...
        function i(e) {
            if (!D.noSwipe || !e.moved) {
                ...
                u && (v = h(Math[L ? I ? "floor" : "ceil" : "round"](n / u) * u, s, t), s = t = v), L && (u || v === n) && (y = -(H / J), E *= h(Math.abs(y), b.timeLow, b.timeHigh), o = Math.round(n + y * E / F), u || (v = o), (!I && o > t || I && s > o) && (q = I ? s : t, x = o - q, u || (v = q), x = h(v + 0.03 * x, q - 50, q + 50), E = Math.abs((n - x) / (y / F)))), E *= w ? 10 : 1, (b.onEnd || g).call(B, d.extend(e, {
                    moved: e.moved || K && u,
                    pos: n,
                    newPos: v,
                    overPos: x,
    ...
    !function (a, b) {
        ...
        function d(a, b, c, d) {
            var e = ["opacity", b, ~~(100 * a), c, d].join("-"), f = 0.01 + c / d * 100, g = Math.max(1 - (1 - a) / b * (100 - f), a), h = m.substring(0, m.indexOf("Animation")).toLowerCase(), i = h && "-" + h + "-" || "";
            return o[e] || (p.insertRule("@" + i + "keyframes " + e + "{0%{opacity:" + g + "}" + f + "%{opacity:" + a + "}" + (f + 0.01) + "%{opacity:1}" + (f + b) % 100 + "%{opacity:" + a + "}100%{opacity:" + g + "}}", p.cssRules.length), o[e] = 1), e;
        }
            ...
            spin: function (b) {
                ...
                if (b && (b.insertBefore(h, b.firstChild || null), d = i(b), c = i(h), g(h, {
                    ...
                    !function s() {
                        ...
                        e.timeout = e.el && setTimeout(s, ~~(1000 / o));
                    }();
                }
                return e;
            }, stop: function () {
    ...
    var Cc, Dc, Ec = d(a), Fc = d(b), Gc = "quirks" === c.hash.replace("#", ""), Hc = uc.csstransforms3d, Ic = Hc && !Gc, Jc = Hc || "CSS1Compat" === b.compatMode, Kc = vc.ok, Lc = navigator.userAgent.match(/Android|webOS|iPhone|iPad|iPod|BlackBerry|Windows Phone/i), Mc = !Ic || Lc, Nc = navigator.msPointerEnabled, Oc = "onwheel" in b.createElement("div") ? "wheel" : b.onmousewheel !== e ? "mousewheel" : "DOMMouseScroll", Pc = 250, Qc = 300, Rc = 1400, Sc = 5000, Tc = 2, Uc = 64, Vc = 500, Wc = 333, Xc = "$stageFrame", Yc = "$navDotFrame", Zc = "$navThumbFrame", $c = "auto", _c = f([0.1, 0, 0.25, 1]), ad = 99999, bd = "50%", cd = {
        width: null,
        minwidth: null,
        maxwidth: "100%",
        height: null,
    ...
    jQuery.Fotorama = function (a, e) {
        ...
        qe[Xc] = d(N(yb)), qe[Zc] = d(N(Mb + " " + Ob + rc, N(ic))), qe[Yc] = d(N(Mb + " " + Nb + rc, N(hc))), Qe[Xc] = [], Qe[Zc] = [], Qe[Yc] = [], Re[Xc] = {}, qe.addClass(Ic ? mb : lb).toggleClass(qb, !e.controlsonstart), ne.fotorama = this, ie.startAutoplay = function (a) {
            ...
            if (Sd) {
                ...
                _(se, {pos: -r(Gd, Le.w, e.margin, Fd), overPos: f, time: d, onEnd: j});
            }
            if (Gc(), Nd) {
                Tc();
            ...
            }, timeLow: 0.5, timeHigh: 2, friction: 5, $wrap: ye
        }), Ne = eb(re, {
