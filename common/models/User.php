...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            $this->isNewRecord ? [['username', 'email', 'password'], 'required'] : [['username', 'email'], 'required'],
    ...
    public function beforeDelete()
    {
        if (parent::beforeDelete()) {
            if ($this->isUserSuperAdmin($this->username)) {
                Yii::$app->session->setFlash('super_admin', 'Super Administrador não pode ser eliminado');
                return false;
            }
            return true;
        } else {
