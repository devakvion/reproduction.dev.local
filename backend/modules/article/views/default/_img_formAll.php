...
<div class="client-img-form">
    <div class="col-md-6" style="overflow: hidden;">
        ...
        <div class="form-group" id="article-img-wr">
            <?php $img = empty($model->img_big) ? 'n.jpg' : $model->id . '/' . $model->img_big; ?>
            <img src="<?= Yii::$app->params['frontUrl'] . $model->imageDir . $img ?>" class="article-upload-img"
            ...
            <?= FileInput::widget([
                ...
                'pluginOptions' => [
                    'uploadAsync' => false,
                    'uploadUrl' => Url::to(['/article/default/upload-img/' . $model->id . '?type=big']),
                    'showCaption' => false,
                    'showPreview' => false,
                ...
                'pluginEvents' => [
                    ...
                    'filebatchuploadsuccess' => 'function(event, data){ $("#article-img-wr .kv-upload-progress").addClass("hide"); $(".article-upload-img").attr({src:data.response}); }',
                ]
